...
<div class="container striped">
	<h1>Follow-Ups</h1>
	<div class="well"> View follow-ups set for:
		<form method="POST" action="/admin/follow-ups.php" id="selectAndGoTarget">
			<select name="employee_id" class="form-control selectAndGoTrigger">
				<?php
do {  
?>
				<option value="<?php echo $row_employees['id']?>"<?php if (!(strcmp($row_employees['id'], $userID_followUps))) {echo "selected=\"selected\"";} ?>><?php echo $row_employees['emp_first_name']?></option>
				<?php
...
?>
	...
	<?php
		...
		<div class="col-sm-6">
			...
			<input class="form-control input-sm col-sm-2" type="date" name="next_step_date" value="<?php echo date('Y-m-d', strtotime("+1 week")); ?>" />
		...
		<div class="col-sm-6">
			<div class="well">
				...
				<div class="row">
					...
					<span class="col-sm-10"><a href="tel:<?php echo $row_followUps['phone']; ?>"><?php echo $row_followUps['phone']; ?></a></span>
				</div>
				<?php } ?>
				
				<?php if($row_followUps['email'] != '') { ?>
				<div class="row">
					<strong class="col-sm-2">E-mail:</strong>
					<span class="col-sm-10"><a href="mailto:<?php echo $row_followUps['email']; ?>"><?php echo $row_followUps['email']; ?></a></span>
				</div>
				<?php } ?>
				
				<div  class="row">
					<strong class="col-sm-2">Address:</strong>
					<span class="col-sm-10">
						<?php echo $row_followUps['physical_address_number']; ?>
						<?php echo $row_followUps['physical_address_street']; ?>, 
						<?php echo $row_followUps['physical_address_city']; ?><br />
				...
				<div class="row">
					<strong class="col-sm-2">Contact:</strong>
					<span class="col-sm-10"><?php echo $row_followUps['contact_name']; ?></span>
				</div>
				<div class="row">
					<strong class="col-sm-2">DBI Rep:</strong>
					<span class="col-sm-10"><?php echo $row_followUps['first_name']; ?> <?php echo $row_followUps['last_name']; ?></span>
				</div>
			</div>
		</div>
	</div>
